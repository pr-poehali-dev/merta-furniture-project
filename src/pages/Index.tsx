    ...
    <div className="min-h-screen bg-[#f9f9f7] font-body text-[#111] page-enter overflow-x-hidden">
      ...
      {cartOpen && (
        <div className="fixed inset-0 z-50">
          ...
          <div className="absolute bottom-0 left-0 right-0 bg-white rounded-t-2xl flex flex-col max-h-[95svh] md:top-0 md:bottom-0 md:left-auto md:right-0 md:w-96 md:h-full md:max-h-full md:rounded-none">
            {/* Handle — mobile only */}
